    ...
    <div class='container'>
        <div class='columns'>
            <div class='column is-4'>
                <img src="https://images.unsplash.com/photo-1546856139-46fb2b57ff21?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60" alt="Cakes">
            </div>
            <div class='column is-4'>            
                <div class='field'>
                    <label>Name</label>
...
export default {
    data(){
        return {
            ...
            // fields
            name: 'Fakela',
            email: 'fakela@gmail.com',
            engravingText: 'yummy cakes',
            address: {
                street: '34 ph',
                city: 'portharcourt',
                state: 'Rivers state',
...
.section{
    background-color: rgb(211, 209, 102);}
</style>
